RUN_NAME = 'testing' # MUST be set. Creates a subfolder in the runs folder with this name, containing data, saved models, etc. IMPORTANT: all models in this folder WILL be overwritten.
